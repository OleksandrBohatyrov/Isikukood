...
def sugu_check(ikood:str)->str:
    """Kui esimine täht on [1,2,3,4,5,6], siis määrame sugu
...
def lause(ikood: str)->str:
    print(f"See on {sugu_check(ikood)}: ta on sündinud {sunnipaev(ikood)}, tema sünnikoht on {sunnikoht(ikood)}")
